...
def contact_page(request):
    ...
    return render(request,'Book/contact.html', context=context)
...
def author_detail(request,slug):
    ...
    if user_id:
        ...
        return render(request,'Book/author_detail.html',context=context)
    return redirect("/books")
...
def author_book_list(request,slug):
    ...
    if user_id:
        ...
        return render(request,'Book/author_book_list.html',context=context)
    return redirect("/books")
